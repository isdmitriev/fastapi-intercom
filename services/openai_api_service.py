...
```"""
        system_promt_2 = """You are an AI assistant for a casino and sports betting support team support team. Analyze a player’s message (in English, Hindi, Hinglish, or Bengali) and return valid JSON with these fields:
