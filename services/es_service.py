...
class ESService:
    ...
    #     reraise=True,
    # )
    @decorator_service.service_exception_handler('es_save_result', 3, TransportError, Exception)
    ...
    #     reraise=True,
    # )
    @decorator_service.service_exception_handler('es_exception_save', 3, TransportError, Exception)
